  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        final selectableDayPredicate = this.selectableDayPredicate;
        ...
        final selectedLastDate = this.selectedLastDate;
        ...
        if (isSelectedFirstDay && (isSelectedLastDay == null || isSelectedLastDay)) {
          ...
          decoration =
              new BoxDecoration(color: themeData.colorScheme.secondary, shape: BoxShape.circle);
          ...
          decoration = new BoxDecoration(
              color: themeData.colorScheme.secondary.withOpacity(0.1), shape: BoxShape.rectangle);
        } else if (disabled) {
...
class _MonthPickerState extends State<MonthPicker> with SingleTickerProviderStateMixin {
  ...
  static int _monthDelta(DateTime startDate, DateTime? endDate) {
    if (endDate != null)
      ...
      return startDate.year * 12 + startDate.month;
  }
  ...
  @override
  Widget build(BuildContext context) {
    final selectedFirstDate = widget.selectedFirstDate;
    final selectedLastDate = widget.selectedLastDate;
    return new SizedBox(
      width: _kMonthPickerPortraitWidth,
            ...
            child: new NotificationListener<ScrollStartNotification>(
              ...
              child: new NotificationListener<ScrollEndNotification>(
                ...
                child: new PageView.builder(
                  key: new ValueKey<DateTime>(
                      selectedLastDate != null ? selectedLastDate : selectedFirstDate),
...
class _YearPickerState extends State<YearPicker> {
  ...
  void initState() {
    ...
    final selectedLastDate = widget.selectedLastDate;
    if (selectedLastDate != null) {
      offset = selectedLastDate.year - widget.firstDate.year;
    } else {
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  void didChangeDependencies() {
    ...
    localizations = MaterialLocalizations.of(context);
    textDirection = Directionality.of(context);
    final selectedFirstDate = _selectedFirstDate;
    if (!_announcedInitialDate && selectedFirstDate != null) {
      _announcedInitialDate = true;
      SemanticsService.announce(
        localizations.formatFullDate(selectedFirstDate),
        textDirection,
      );
      final selectedLastDate = _selectedLastDate;
      if (selectedLastDate != null) {
        SemanticsService.announce(
          localizations.formatFullDate(selectedLastDate),
          textDirection,
        );
      }
    }
    ...
    setState(() {
      ...
      if (_mode == DatePickerMode.day) {
        ...
        if (selectedFirstDate != null)
          SemanticsService.announce(
              localizations.formatMonthYear(selectedFirstDate), textDirection);
        final selectedLastDate = _selectedLastDate;
        if (selectedLastDate != null) {
          SemanticsService.announce(localizations.formatMonthYear(selectedLastDate), textDirection);
        }
      } else {
        final selectedFirstDate = _selectedFirstDate;
        if (selectedFirstDate != null)
          SemanticsService.announce(localizations.formatYear(selectedFirstDate), textDirection);
        final selectedLastDate = _selectedLastDate;

        if (selectedLastDate != null) {
          SemanticsService.announce(localizations.formatYear(selectedLastDate), textDirection);
        }
      }
    });
  }
  ...
  void _handleCancel() {
    final initialLastDate = widget.initialLastDate;
    if (initialLastDate != null) {
      Navigator.pop(
        context,
        DateTimeRange(start: widget.initialFirstDate, end: initialLastDate),
      );
    } else {
      Navigator.pop(context);
    }
  ...
  void _handleOk() {
    final selectedLastDate = _selectedLastDate;
    final selectedFirstDate = _selectedFirstDate;
    if (selectedLastDate != null && selectedFirstDate != null) {
      Navigator.pop(context, DateTimeRange(start: selectedFirstDate, end: selectedLastDate));
    } else {
      final date = _selectedFirstDate ?? _selectedLastDate;
      if (date != null) {
  ...
  Widget? _buildPicker() {
    ...
    if (selectedFirstDate != null && firstDate != null && lastDate != null)
      switch (mode) {
        ...
        child: Row(
          children: <Widget>[
            TextButton(
              child: Text(
                'СБРОСИТЬ',
                style: TextStyle(color: theme(context).warningColor),
              ),
...
abstract class AppDateRangePicker {
  ...
  static Future<DateTimeRange> show({
    ...
    return await AppDialog.showFullyCustom(
      (context) => Stack(
        children: [
          Positioned.fill(
